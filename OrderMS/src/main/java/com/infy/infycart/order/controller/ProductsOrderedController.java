...
import com.infy.infycart.order.service.ProductsOrderedService;
...
public class ProductsOrderedController {
	...
	public ResponseEntity<String> addProduct(@RequestBody ProductsOrderedDTO productsOrderedDTO){
		SubscribedproductDTO[] subscribedproductsDTO = new RestTemplate().getForObject("http://localhost:7200/api/subscriptions/"+productsOrderedDTO.getBuyerId(), SubscribedproductDTO[].class);
